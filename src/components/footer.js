...
export function Footer() {
  ...
  return (
    <footer className="footer mt-20">
      ...
      <ul className="menu">
        <li className="menu__item"><div className="menu__link cursor-pointer" onClick={() => router.push('/')} to="/">Home</div></li>
        <li className="menu__item"><div className="menu__link cursor-pointer" onClick={() => router.push('/about')} to="/about">About</div></li>
        <li className="menu__item"><div className="menu__link cursor-pointer" href="#">Services</div></li>
        <li className="menu__item"><div className="menu__link cursor-pointer" href="#">Team</div></li>
        <li className="menu__item"><div className="menu__link cursor-pointer" href="#">Contact</div></li>
      </ul>
      <div className="card">
      ...
      <p>&copy;2024 Mohit Patoliya | All Rights Reserved</p>
    </footer>
  );
}
